"""
IMIRROR4FREE — Startup wrapper for the built EXE.
...
def write_crash_log(error_text: str) -> str | None:
    ...
    try:
        ...
        with open(log_path, "w", encoding="utf-8") as f:
            f.write(f"IMIRROR4FREE Crash Log — {datetime.now()}\n")
            f.write("=" * 60 + "\n\n")
...
if __name__ == "__main__":
    try:
        ...
        msg = f"IMIRROR4FREE failed to start:\n\n{type(e).__name__}: {e}\n\n"
        if log_path:
        ...
        msg += (
            ...
            "Report issues at:\nhttps://github.com/unluckybob/imirror4free/issues"
        )

        show_error_dialog("IMIRROR4FREE — Startup Error", msg)
        sys.exit(1)
